...
import {
  ...
  , SettingsOutlined, Campaign, CottageOutlined, FlashOffTwoTone
    ...
    <div className={'header'}>
      <div className='topline'>
        <div className='info'>
          ...
          <p className='fn-clear'>
            ...
            <span className='fr2'>&emsp;{/*myCompany[0].company_asset*/}${user.cash.toLocaleString("en-US")}</span>
          </p>
        </div>
      </div>
      ...
      <div className='set'>
        <Button onClick={() => { }} style={{ color: "white" }} >
          <SettingsOutlined style={{ fontSize: "36px" }} />
        </Button>
      </div>
      <div className='home'>
        <Button
          href={homeLink}
          onClick={() => { }}
          style={{ color: "black", zIndex: '30' }} >
          <CottageOutlined style={{ fontSize: "36px" }} />
        </Button>
      </div>
