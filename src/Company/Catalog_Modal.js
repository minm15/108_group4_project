...
export default function Catalog_Modal({title, content,catalog_id }) {
  ...
  return (
    <div>
      ...
      >
        <Box sx={style}> 
        {/* <Button startIcon={<ForwardToInbox />} onClick={handleLunch} >發布</Button> */}
        <Grid container spacing={0}>
        <Grid item={10}>
        <Paper elevation={3} sx={{width:780,bgcolor:'#FDF1EF'}}>
