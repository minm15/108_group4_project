...
function Catalog_Add2() {
  ...
  for (let i=0;i<myCompany[0].myProductList.length;i++) {
     if(!uniqProductName.includes(myCompany[0].myProductList[i].product_name)){
      uniqProductName.push(myCompany[0].myProductList[i].product_name)
   }
...
const MyProduct=({})=>{
  ...
  return(
    <div>
    {myCompany[0].myProductList.map((row) => (
